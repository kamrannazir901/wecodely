    ...
    <body class="bg-white text-gray-900">
        ...
        <main>
            ...
            <a href="https://wa.me/923185421345?text={{ urlencode('Hi Wecodely, I would like to discuss my requirements.') }}"
                target="_blank" rel="noopener noreferrer" aria-label="Chat with Wecodely on WhatsApp"
                title="Chat on WhatsApp"
                class="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-600 text-white shadow-lg transition duration-300 hover:bg-green-700 hover:shadow-xl">

                <!-- WhatsApp Symbol -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="white" class="h-8 w-8">
